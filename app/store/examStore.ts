...
import { databases, Query, ID, EXAMS_COLLECTION_ID, FACULTIES_COLLECTION_ID, SECTIONS_COLLECTION_ID, STUDENTS_COLLECTION_ID, getCurrentUserEmail } from '~/utils/appwrite';
...
// import { useSchoolConfigStore, selectDbId } from '~/store/schoolConfigStore';
// const APPWRITE_DATABASE_ID = useSchoolConfigStore(selectDbId) as string; // Get dbId from Zustand

// import { useGlobal } from '~/GlobalContext'
// const { globalVar, setGlobalVar } = useGlobal()


// const { dbId} = useSchool();
