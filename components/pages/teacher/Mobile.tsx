...
import GeneralComponent from "./General"; // Import GeneralComponent
...
import TeacherNotificationPage from "./components/TeacherNotificationPage";
...
const Layout: React.FC = () => {
    ...
    const renderActiveComponent = () => {
        switch (activeComponent) {
            ...
            case "Notification":
                return <TeacherNotificationPage />;
            case "Braimy":
