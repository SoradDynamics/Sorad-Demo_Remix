...
const Layout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-100"> {/* Changed h-screen to min-h-screen and bg-gray-100 for softer background */}
            ...
            <div className="sticky bottom-0 bg-slate-300/90 rounded-t-lg backdrop-blur-sm border-t border-gray-200"> {/*  White background with transparency, blur, border, sticky footer */}
